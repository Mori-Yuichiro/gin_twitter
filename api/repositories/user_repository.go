...
func (ur *userRespository) GetUserByUserId(user *models.User, userId uint) error {
	...
	}).Preload("Tweets.User").Preload("Tweets.Retweets").Preload("Tweets.Favorites").Preload("Tweets.Bookmarks").Preload("Comments").Preload("Comments.User").Preload("Retweets").Preload("Retweets.Tweet").Preload("Retweets.Tweet.User").Preload("Retweets.Tweet.Retweets").Preload("Retweets.Tweet.Favorites").Preload("Retweets.Tweet.Bookmarks").Preload("Favorites").Preload("Favorites.Tweet").Preload("Favorites.Tweet.User").Preload("Favorites.Tweet.Retweets").Preload("Favorites.Tweet.Favorites").Preload("Favorites.Tweet.Bookmarks").Where("id=?", userId).First(user).Error; err != nil {
		return err
	}
	return nil
}
